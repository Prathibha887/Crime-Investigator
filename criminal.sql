...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 21, 2024 at 03:31 AM
...
(1, '1', '1000', 'megha', 'civil', 'abc', '9874563210', 'Closed');
...
--
-- Table structure for table `lostandfoundtype`
--

CREATE TABLE `lostandfoundtype` (
  `idlostandfoundtype_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `online_fine`
--

CREATE TABLE `online_fine` (
  `ID` int(11) NOT NULL,
  `FINE_NO` varchar(45) DEFAULT NULL,
...
INSERT INTO `registration` (`UserId`, `Username`, `Password`, `Email`, `Usertype`) VALUES
(1, 'admin', 'admin1', 'ashikachi486@gmail.com', 'Admin'),
(2, 'Preetham d', 'admin', 'preethu10@gmail.com', 'Admin');
...
--
-- Indexes for table `lostandfoundtype`
--
ALTER TABLE `lostandfoundtype`
  ADD PRIMARY KEY (`idlostandfoundtype_id`);

--
-- Indexes for table `online_fine`
--
ALTER TABLE `online_fine`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `lostandfoundtype`
--
ALTER TABLE `lostandfoundtype`
  MODIFY `idlostandfoundtype_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `online_fine`
--
ALTER TABLE `online_fine`
