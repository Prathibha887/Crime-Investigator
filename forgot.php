...
<?php
    ...
    if ($resu) {
        ...
        if ($c_password == $n_password) {
            ...
            echo "<script>alert('username confirmation doesnot match!');location.href='forgot.php'</script>";
        }
        } else {

        echo "<script>alert('username doesnot match!');location.href='forgot.php'</script>";
      ...
      <div class="">
        <form method="post">
          ...
          <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock" style="color:#15B9D9"></i></span>
            ...
            <span style="margin-top:0px; margin-left:310px;"><i id="ctoggler"class="far fa-eye"></i></span>
          </div>
...
var ctoggler = document.getElementById('ctoggler');
...
ctoggler.classList.add('fa-eye-slash');
} else {
ctoggler.classList.remove('fa-eye-slash');
cpassword.setAttribute('type', 'password');
}
};
ctoggler.addEventListener('click', showHidePassword);
</script>
