...
<?php
    ...
    $qry = "SELECT Password from login where Password = '$o_password'" ;
    ...
    if ($resu) {
        ...
        if ($c_password == $n_password) {
            ...
            $passqry = "UPDATE Login SET Password = '$n_password' where Password= '$o_password'";
        
            if ($conn->query($passqry) === TRUE) {
                echo "<script>alert('Password updated successfully!');location.href='forgot.php'</script>";
            } else {
                echo "<script>alert('Error updating password');location.href='forgot.php'</script>";
            }
        } else {
        
            echo "<script>alert('Password confirmation doesnot match!');location.href='forgot.php'</script>";
        }
        } else {

        echo "<script>alert('Old password doesnot match!');location.href='forgot.php'</script>";
      ...
      <div class="">
        <form method="post">
          <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock" style="color:#15b9d9"></i></span>
            <input type="password" name="o_password" placeholder="Old Password" required />
          </div>
          <div class="input_field"> <span><i aria-hidden="true" class="fa fa-lock" style="color:#15b9d9"></i></span>
          ...
          <input class="button" type="submit" value="Continue" name="changepass" />
            <!-- <div class="input_field checkbox_option"> -->
            <!-- <p><a href="register.php">Forgot Pssword</a></p> -->
            <!-- </div> -->
        </form>
      </div>
    </div>
